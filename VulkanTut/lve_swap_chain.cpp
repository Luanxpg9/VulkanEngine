...
namespace lve {
    ...
    VkPresentModeKHR LveSwapChain::chooseSwapPresentMode(
        ...
        // Mailbox - Low Latency, High power Consumption, Not aways supported
        ...
        // FIFO - Vsync bound, Goof for mobile, Always Supported, More latency
        // for (const auto &availablePresentMode : availablePresentModes) {
        ...
        // Immediate - High Power Consumption, Tearing, Low Latency, Usually Supported
